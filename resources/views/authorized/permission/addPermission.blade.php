...
@endsection @section('content')
    <div class="panel panel-bordered panel-primary">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => 'authorized/permission/add-permission', 'method' => 'post', 'class' => 'panel-body form-horizontal form-padding']) !!}
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="selectpicker" name="description" id="description" value="{{ old('description') }}">
