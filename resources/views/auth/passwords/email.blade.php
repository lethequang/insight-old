...
<head>
    ...
    <link href="{{ asset('public/assets/css/nifty.min.css') }}" rel="stylesheet">


    <!--Nifty Premium Icon [ DEMONSTRATION ]-->
    <link href="{{ asset('public/assets/css/demo/nifty-demo-icons.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('public/assets/plugins/pace/pace.min.css') }}" rel="stylesheet">
    <script src="{{ asset('public/assets/plugins/pace/pace.min.js') }}"></script>


        
    <!--Demo [ DEMONSTRATION ]-->
    <link href="{{ asset('public/assets/css/demo/nifty-demo.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('public/assets/js/demo/bg-images.js') }}"></script>
